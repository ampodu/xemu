...
public:
    ...
    void Draw()
    {
        ...
        ImGui::Combo("###mem", (int*)&g_config.sys.mem_limit, "64 MiB\0" "128 MiB\0");
        ImGui::NextColumn();
...
public:
    ...
    void Draw()
    {
        ...
        ImGui::Combo("##backend", is_enabled ? &temp_backend : (int*)&g_config.net.backend, "NAT\0UDP Tunnel\0Bridged Adapter\0");
...
static void ShowMainMenu()
{
    ...
    if (ImGui::BeginMainMenuBar())
    {
        ...
        if (ImGui::BeginMenu("View"))
        {
            ...
            if (ImGui::Combo(
                    "Scaling Mode", (int*)&g_config.display.ui.fit, "Center\0Scale\0Scale (Widescreen 16:9)\0Scale (4:3)\0Stretch\0")) {
            }
